...
VALUES $sql_part");
    ...
    public static function mailOrder($order_id,$user_email){
        ...
        //massage client
        $message_client = (new Swift_Message("Замовлення №{$order_id}"))
            ->setFrom([App::$app->getProperty('smtp_login') => App::$app->getProperty('shop_name')])
            ->setTo($user_email)
            ->setBody($body,'text/html')
        ;
        //massage admin
        $message_admin = (new Swift_Message("На сайті зробили замовлення №{$order_id}"))
            ->setFrom([App::$app->getProperty('smtp_login') => App::$app->getProperty('shop_name')])
        ...
        $_SESSION['success'] = "Дякуємо за замовлення, адміністратор зв'яжеться з вами найблищим часом" ;
