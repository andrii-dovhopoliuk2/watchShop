            ...
            <div class="col-md-9 single-main-left">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            > <?=$curr["symbol_left"];?> <?=$product['price'] * $curr['value'];?>
                                ...
                                <div class="available">
                                <ul> <?php if (!empty($mods)):?>
                                    <li>Color
                                        <select>

                                            <option>Вибрати колір</option>
                            ...
                            <div class="quantity">
                                <input type="number" size="4"  value="1" name="quantity" min="1"
                                step="1" >
                ...
                <div class="latestproducts">
                    <div class="product-one">
                        <h3>З цим товаром також купляють:</h3>
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <p>Explore Now</p>
                                    <h4>
                                        <a class="item_add add-to-cart-link" href="cart/add?id=<?=$item['id']?>" data-id="<?=$item['id']?>"><i>
                                            </i></a> <span class="item_price"> <?=$curr["symbol_left"];?> <?=$item['price'] * $curr['value'];?>
                                            <?=$curr["symbol_right"];?>
                                ...
                                <div class="srch">
                                    <?php if ($item['old_price']&&$item['old_price']>$item['price']):?>
                                        ...
                                        <span><?php
                                            $value1 = $item['price'] / $item['old_price'] * 100;
                                            $value1 = 100 - $value1;
                                            echo round($value1,1);
                                            ?> %</span>
                                    <?php endif;?>
