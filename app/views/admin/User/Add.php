                ...
                <form method="post" action="/user/signup" role="form" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input class="form-control" name="password" id="password" type="password" data-minlength="6" data-error="Пароль повинен включати не менше шести символів" required>
                    ...
                    <div class="box-footer">
                        <input type="hidden" name="ThisRole" value="admin">
