                ...
                <form action="<?=ADMIN;?>/category/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="title" class="form-control" id="title" placeholder="Найменування категорії" value="<?=h($category->title);?>" required>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success">Застосувати редагування</button>
                    </div>
                </form>
            </div>
        </div>
