                ...
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="title" class="form-control" id="title" placeholder="Назва" value="<?=h($product->title);?>" required>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="price" class="form-control" id="description" placeholder="Цена" pattern="^[0-9.]{1,}$" value="<?=$product->price;?>" required data-error="Допускаються цифри і десяткова крапка">
                            <div class="help-block with-errors"></div>
                        </div>

                        <div class="form-group has-feedback">
                            <label for="old_price">Стара ціна</label>
                            <input type="text" name="old_price" class="form-control" id="description" placeholder="Старая ціна" pattern="^[0-9.]{1,}$" value="<?=$product->old_price;?>" data-error="Допускаються цифри і десяткова крапка">
                            <div class="help-block with-errors"></div>
                        </div>
