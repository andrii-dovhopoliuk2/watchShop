                            ...
                            <form method="post" action="cart/checkout" role="form" data-toggle="validator">
                                <?php if(!isset($_SESSION['user'])): ?>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="password" name="password" class="form-control" id="pasword" placeholder="Password" value="<?= isset($_SESSION['form_data']['password']) ? $_SESSION['form_data']['password'] : '' ?>" data-minlength="6" data-error="Пароль має включати не менше 6 символів" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group">
                                    <label for="address">Побажання</label>
