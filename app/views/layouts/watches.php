...
<html>
<head>
    <link id="favicon" rel="icon" type="image/png" href="/public/images/favicon.png" count="0">
    <base href="/">
						...
						<div class="box">
						    ...
						    <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <?php if (!empty($_SESSION['user'])):?>
                                        <li><a href="user/cabinet">Ласкаво просимо, <?=h($_SESSION['user']['name']);?></a></li>
                                        <li><a href="user/cabinet">Особистий кабінет, <?=h($_SESSION['user']['name']);?></a></li>
